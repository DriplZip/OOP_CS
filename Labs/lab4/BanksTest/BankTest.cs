...
namespace BanksTest
{
    public class Test
    {
        ...
        public void WhenCentralBank_AndAddBank_ThenBankShouldBeCreated()
        {
            ...
            BankConfig bankConfig = new BankConfig(name, commission, percent, smallPercentage, averagePercentage,
                largePercentage, creditLimit, transferLimit, withdrawalUnlockDate);
        ...
        public void WhenCentralBank_AndAddClient_ThenClientShouldBeCreated()
        {
            ...
            decimal transferLimit = 1000;
            DateTime withdrawalUnlockDate = new DateTime(2023, 1, 1);
            BankConfig bankConfig = new BankConfig(bankName, commission, percent, smallPercentage, averagePercentage,
                largePercentage, creditLimit, transferLimit, withdrawalUnlockDate);
            Bank bank = new Bank(bankConfig);
            CentralBank centralBank = new CentralBank();
