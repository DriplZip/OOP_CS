...
namespace Backups.Extra.Entities
{
    ...
    {
        public BackupTaskExtra(string name, IStorageAlgorithm storageAlgorithm, IRepository repository, IArchiver archiver, ICleanupAlgorithm cleanupAlgorithm, LoggerType loggerType, string logFile = null) : base(name, storageAlgorithm, repository, archiver)
        {
